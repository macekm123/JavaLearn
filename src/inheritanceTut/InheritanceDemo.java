...
class InheritanceDemo {
	public static void main(String[] args) {
		...
		System.out.println("Gear is: " + downhillBike.gear);
		System.out.println("Seat height is: " + downhillBike.seatHeight);
		System.out.println("Bike speed is: " + downhillBike.speed);
		System.out.println("Wheel size is: " + downhillBike.wheelSize);
		downhillBike.changeWheelSize(20);
		System.out.println("Bike wheel size after changing wheel is: " + downhillBike.wheelSize);
